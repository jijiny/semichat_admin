...
<table class="table" style="margin: 0 auto; margin-top: 10px; width: 80%;">
   <tr style="background-color: lightgray;">
   	<th style="text-align: center; width: 40%;">문의 유형</th>
   	<th style="text-align:center; width:60%">제목</th>
    </tr>
    <tr style="background-color: lightgray;">
      <td style="text-align: center; width: 40%;" >${board.iBoardInquiryType }</td>
      <td style="text-align:center; width:60%">${board.iBoardTitle }</td>
    </tr>
   <tr>
   ...
   <tr>
		...
		<td>첨부파일<a href="/admin/filedown?fileno=${file.fileNo }">${ file.originalName}</a></td>
   </tr>
</table>
</form>
</div>   
...
<a href="/admin/inquirymanage"><button class="btn btn-md b-btn" style="float: left; background-color: #4ea1d3; color: white;">목록</button></a>
<button class="btn btn-md b-btn btnUpdate" id="btnUpdate" style="float: right; background-color: #4ea1d3; color: white; float: right;" data-toggle="modal" data-target="#myModal">답변 등록</button>
</div>
